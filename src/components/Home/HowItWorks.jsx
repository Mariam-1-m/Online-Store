...
export default function HowItWorks() {
  return (
    <div className="ShopSection bg-[#1E293B]  flex flex-col items-center justify-center h-[75vh] p-6">

  {/* Header */}
  <div className="container1 text-center mb-12">
    <h2 className="ShopHeading2 text-4xl md:text-5xl font-extrabold text-slate-900 tracking-tight">
      How It Works
    </h2>
  ...
  <div className="container2 grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-7xl px-8">
