...
function PaymentMethodeCard({paymentMethode,setPaymentMethode}){
return(
...
<select className="hidden" onChange={(e)=>setPaymentMethode(e.target.value)}>
...
<CreditCard size={18} className="m-auto text-indigo-600"/>
  ...
  <div className="flex flex-col justify-around">
    <h4 className="hidden font-bold">{paymentMethode}</h4>
