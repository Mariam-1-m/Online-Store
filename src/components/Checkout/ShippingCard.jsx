...
<form className="flex flex-col justify-between gap-4 w-[95%] h-auto ">
<div className='grid grid-cols-1 md:grid-cols-2 gap-4 '>
<div className='flex flex-col gap-2 '>
    <label className='block text-xs'>Full Name <span>*</span></label>
    <input type='text' required className='rounded-md px-3 py-2 border-2 focus:border-indigo-600 w-full  border-slate-200  dark:border-[#23304a] border'/>
</div>
...
<div className='flex flex-col gap-2 w-[50%]  '>
    ...
    <input type='text'  className='rounded-md px-3 py-2 border-2 focus:border-indigo-600 w-full  border-slate-200  dark:border-[#23304a] border'/>
</div>
</div>
