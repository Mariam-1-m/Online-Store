 ...
 function Footer() {
    ...
    <div className="logo rounded-2xl overflow-hidden text-2xl font-bold mb-5 text-indigo-600"><img src={logoImage} alt="" className="w-18 h-10 "/></div>
         ...
         <div className="rightSide  w-1/2 h-auto  flex flex-col md:flex-row items-start justify-between gap-8 pr-[10%] pt-6  pb-10">
            ...
            <ul className="">
               <li><NavLink className=" text-1xs text-gray-500 dark:text-gray-400 hover:text-indigo-600" to="/products">shop</NavLink></li>
               <li><NavLink className=" text-1xs text-gray-500 dark:text-gray-400 hover:text-indigo-600" to="/orders">My Orders</NavLink></li>
               <li><NavLink className=" text-1xs text-gray-500 dark:text-gray-400 hover:text-indigo-600" to="/wishlist">Wishlist</NavLink></li>
               <li><NavLink className=" text-1xs text-gray-500 dark:text-gray-400 hover:text-indigo-600" to="/profile">Profile</NavLink></li>
...
<p className="text-gray-500 dark:text-gray-400 text-sm">© 2026 Koda Store. All rights reserved.</p>
        </div>
        </div>
    );
}
